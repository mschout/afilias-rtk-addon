...
**/
public class PolicyDeleteSessionExample extends SessionExample
{
    ...
    {
        SessionExample example = new PolicyDeleteSessionExample(args);
        example.session();
    }

    public PolicyDeleteSessionExample(String args[])
    {
        super(args);
    ...
    protected String getUsage()
    {
        return super.getUsage()
            + " domain_name year policy_delete_reason";
    }
	...
	private void  deleteDomain() throws epp_XMLException, epp_Exception, Exception 
    {
        ...
        PolicyDelete policyDelete = new PolicyDelete();
        policyDelete.setReason(reason);

		epp_Extension[] extensions = {policyDelete};
		domain_delete_request.getCmd().setExtensions(extensions);
