...
**/
public class DomainSyncSessionExample extends SessionExample
{
    ...
    private String newExDate = null;
    private String newExTime = null;
    ...
    {
        SessionExample example = new DomainSyncSessionExample(args);
        example.session();
    }

    public DomainSyncSessionExample(String args[])
    {
        super(args);
        domain_name = nextArgument();
        //domain_name = String.valueOf(new Random().nextInt(1000)) + ".info";
        year = nextArgument(); 
        newExDate = nextArgument();
        newExTime = nextArgument();
        assertNotNull(domain_name);
        assertNotNull(year);
        assertNotNull(newExDate);
    ...
    protected String getUsage()
    {
        return super.getUsage()
            + " domain_name year new_expiry_date";
    }
...
//        String year[] = newExDate.split(" ");   
//        System.out.println("new ex date " + newExDate);
//        System.out.println("new ex time " + newExTime);
//        System.out.println("year " + year[0] + "      " + year[1]);
        DomainSync domainSync = new DomainSync();
        String s = newExDate + "T" + newExTime + "Z";
        domainSync.setNewExDate(s);

		epp_Extension[] extensions = {domainSync};
