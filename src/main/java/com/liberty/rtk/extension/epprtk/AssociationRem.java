...
public class AssociationRem
{
    ...
    {
        if (contacts_ == null) throw new epp_XMLException("association:update.association:rem missing association:contact");
        Element e = doc.createElement("association:rem");
